...
export default function ElderHomePage() { const me = useSession(); return <AppShell title="홈" active="home" bell>
  <h2 className="absolute left-[68px] top-[34px] m-0 text-[28px] font-semibold">안녕하세요, {me.name}님!</h2><p className="absolute left-[68px] top-[74px] m-0 text-[20px] text-[#6b6b6b]">오늘도 안전한 금융 생활을 확인해보세요.</p>
